...
export const NewRestaurant = () => {
  ...
  let restaurantIds = useSelector(state => state.restaurants.ids);

  let restaurantId = restaurantIds[restaurantIds.length -1]
  ...
  useEffect(() => {
    if (status === 'succeeded') {
      history.push(`/restaurants/${restaurantId}/review`);
    }
  }, [history, restaurantId, status]);
